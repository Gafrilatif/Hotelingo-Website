...
<?php
    ...
    if(isset($_GET['Book_ID'])){
        ...
        if($bookID >= 100 && $bookID <= 200){
            $query = "SELECT * FROM booking_table WHERE Book_ID = '$bookID';";
            ...
            $query = "SELECT * FROM booking_table2 WHERE Book_ID = '$bookID';";
            $sql = mysqli_query($conn, $query);
            ...
            $query = "SELECT * FROM booking_table3 WHERE Book_ID = '$bookID';";
            $sql = mysqli_query($conn, $query);
    ...
    <?php } ?>
        ...
        <section class="profile-container">
                ...
                <form class="row" action="update.php" method="POST">
                    ...
                    <input id="startDate" class="form-control" type="date" name="startDate" value="<?php echo $startDate; ?>" />
                    <label for="endDate">End</label>
                    <input id="endDate" class="form-control" type="date" name="endDate" value="<?php echo $endDate; ?>" />
