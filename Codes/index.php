...
<body class="fade-in-animation">
  ...
  <div class="background-container">
    <img src="image/hotelwhite.jpeg" class="background-image" alt="...">
    <div class="background-overlay"></div>
    <div class="centered-text">
      <h1>HOTELINGO</h1>
      <h6>5 Star Luxury Hotel by k4</h6>
      <br>
      <br>
      <h5>You can order the best accommodation destinations from our website, which is available at any time and from anywhere in the world.</h5>
    </div>
    <a href="book.php" class="book-button">
      <span>Book Now</span>
    </a>
  </div>
</body>
